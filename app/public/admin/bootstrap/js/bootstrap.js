...
+function ($) {
  ...
  Carousel.prototype.slide = function (type, next) {
    ...
    let slidEvent = $.Event('slid.bs.carousel', { relatedTarget, direction }); // yes, "slid"
...
+function ($) {
  ...
  Collapse.prototype.show = function () {
    ...
    let activesData;
    let actives = this.$parent && this.$parent.find('> .panel').children('.in, .collapsing');
  ...
  $(document).on('click.bs.collapse.data-api', '[data-toggle="collapse"]', function (e) {
    ...
    let option = data ? 'toggle' : $.extend({}, $this.data(), { trigger: this });
...
+function ($) {
  ...
  Dropdown.prototype.keydown = function (e) {
    ...
    let desc = ' li:not(.divider):visible a';
...
+function ($) {
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      let options = typeof option === 'object' && option;
      let selector = options && options.selector;
